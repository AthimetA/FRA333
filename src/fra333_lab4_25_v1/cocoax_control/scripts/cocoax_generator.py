...
class CocoaGenerator(Node):
    ...
    def trajectory_service_callback(self, request: CocoaXGenerator, response: CocoaXGenerator):
        ...
        self.get_logger().info(f'{Ax[1,0]:.5f}t + {Ax[2,0]:.5f}t^2 + {Ax[3,0]:.5f}t^3 + {Ax[4,0]:.5f}t^4 + {Ax[5,0]:.5f}t^5')
        self.get_logger().info(f'Trajectory Polynomial (y-axis):')
        self.get_logger().info(f'{Ay[1,0]:.5f}t + {Ay[2,0]:.5f}t^2 + {Ay[3,0]:.5f}t^3 + {Ay[4,0]:.5f}t^4 + {Ay[5,0]:.5f}t^5')
        self.get_logger().info(f'Trajectory Polynomial (z-axis):')
        self.get_logger().info(f'{Az[1,0]:.5f}t + {Az[2,0]:.5f}t^2 + {Az[3,0]:.5f}t^3 + {Az[4,0]:.5f}t^4 + {Az[5,0]:.5f}t^5')
        self.get_logger().info('='*50)
