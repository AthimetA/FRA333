...
#include "cocoav_interfaces/msg/detail/cocoa_vimu__rosidl_typesupport_fastrtps_c.h"
...
using _CocoaVIMU__ros_msg_type = cocoav_interfaces__msg__CocoaVIMU;
...
size_t get_serialized_size_cocoav_interfaces__msg__CocoaVIMU(
  const void * untyped_ros_message,
...
static uint32_t _CocoaVIMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cocoav_interfaces__msg__CocoaVIMU(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cocoav_interfaces
size_t max_serialized_size_cocoav_interfaces__msg__CocoaVIMU(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cocoav_interfaces__msg__CocoaVIMU(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_CocoaVIMU = {
...
static rosidl_message_type_support_t _CocoaVIMU__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CocoaVIMU,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cocoav_interfaces, msg, CocoaVIMU)() {
  return &_CocoaVIMU__type_support;
}
