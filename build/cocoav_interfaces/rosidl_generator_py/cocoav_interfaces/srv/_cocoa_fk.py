...
class Metaclass_CocoaFK(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cocoav_interfaces.srv import _cocoa_fk
...
class CocoaFK(metaclass=Metaclass_CocoaFK):
    from cocoav_interfaces.srv._cocoa_fk import CocoaFK_Request as Request
    from cocoav_interfaces.srv._cocoa_fk import CocoaFK_Response as Response
