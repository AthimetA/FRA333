...
class Metaclass_SolveIK(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cocoav_interfaces.srv import _solve_ik
...
class SolveIK(metaclass=Metaclass_SolveIK):
    from cocoav_interfaces.srv._solve_ik import SolveIK_Request as Request
    from cocoav_interfaces.srv._solve_ik import SolveIK_Response as Response
