...
#ifndef COCOAV_INTERFACES__SRV__DETAIL__COCOA_VFK__FUNCTIONS_H_
#define COCOAV_INTERFACES__SRV__DETAIL__COCOA_VFK__FUNCTIONS_H_
...
/// Initialize srv/CocoaVFK message.
/**
...
/// Create srv/CocoaVFK message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoav_interfaces__srv__CocoaVFK_Request__init().
...
/// Destroy srv/CocoaVFK message.
/**
 * It calls
 * cocoav_interfaces__srv__CocoaVFK_Request__fini()
...
/// Check for srv/CocoaVFK message equality.
/**
...
/// Initialize array of srv/CocoaVFK messages.
/**
...
/// Finalize array of srv/CocoaVFK messages.
/**
 * It calls
 * cocoav_interfaces__srv__CocoaVFK_Request__fini()
...
/// Create array of srv/CocoaVFK messages.
/**
 * It allocates the memory for the array and calls
 * cocoav_interfaces__srv__CocoaVFK_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CocoaVFK messages.
/**
 * It calls
 * cocoav_interfaces__srv__CocoaVFK_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CocoaVFK message array equality.
/**
...
/// Copy an array of srv/CocoaVFK messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoav_interfaces__srv__CocoaVFK_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoav_interfaces
...
/**
 * It calls
 * cocoav_interfaces__srv__CocoaVFK_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoav_interfaces
...
/**
 * It allocates the memory for the array and calls
 * cocoav_interfaces__srv__CocoaVFK_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoav_interfaces
...
/**
 * It calls
 * cocoav_interfaces__srv__CocoaVFK_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COCOAV_INTERFACES__SRV__DETAIL__COCOA_VFK__FUNCTIONS_H_
