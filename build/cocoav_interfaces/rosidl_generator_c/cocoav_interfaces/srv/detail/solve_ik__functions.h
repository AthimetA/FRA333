...
#ifndef COCOAV_INTERFACES__SRV__DETAIL__SOLVE_IK__FUNCTIONS_H_
#define COCOAV_INTERFACES__SRV__DETAIL__SOLVE_IK__FUNCTIONS_H_
 ...
 * calls
 * cocoav_interfaces__srv__SolveIK_Request__init().
...
/**
 * It calls
 * cocoav_interfaces__srv__SolveIK_Request__fini()
 ...
 * cocoav_interfaces__srv__SolveIK_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cocoav_interfaces__srv__SolveIK_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoav_interfaces__srv__SolveIK_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoav_interfaces
...
/**
 * It calls
 * cocoav_interfaces__srv__SolveIK_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoav_interfaces
...
/**
 * It allocates the memory for the array and calls
 * cocoav_interfaces__srv__SolveIK_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoav_interfaces
...
/**
 * It calls
 * cocoav_interfaces__srv__SolveIK_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COCOAV_INTERFACES__SRV__DETAIL__SOLVE_IK__FUNCTIONS_H_
