...
static const _CocoaFK_Request_type_support_symbol_names_t _CocoaFK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoav_interfaces, srv, CocoaFK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoav_interfaces, srv, CocoaFK_Request)),
  }
};
...
{
  return &::cocoav_interfaces::srv::rosidl_typesupport_cpp::CocoaFK_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cocoav_interfaces, srv, CocoaFK_Request)() {
  return get_message_type_support_handle<cocoav_interfaces::srv::CocoaFK_Request>();
}
...
static const _CocoaFK_Response_type_support_symbol_names_t _CocoaFK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoav_interfaces, srv, CocoaFK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoav_interfaces, srv, CocoaFK_Response)),
  }
};
...
{
  return &::cocoav_interfaces::srv::rosidl_typesupport_cpp::CocoaFK_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cocoav_interfaces, srv, CocoaFK_Response)() {
  return get_message_type_support_handle<cocoav_interfaces::srv::CocoaFK_Response>();
}
...
static const _CocoaFK_type_support_symbol_names_t _CocoaFK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoav_interfaces, srv, CocoaFK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoav_interfaces, srv, CocoaFK)),
  }
};
...
{
  return &::cocoav_interfaces::srv::rosidl_typesupport_cpp::CocoaFK_service_type_support_handle;
}
