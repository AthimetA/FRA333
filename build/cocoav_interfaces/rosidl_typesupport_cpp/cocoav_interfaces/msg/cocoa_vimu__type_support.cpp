...
static const _CocoaVIMU_type_support_symbol_names_t _CocoaVIMU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoav_interfaces, msg, CocoaVIMU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoav_interfaces, msg, CocoaVIMU)),
  }
};
...
{
  return &::cocoav_interfaces::msg::rosidl_typesupport_cpp::CocoaVIMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cocoav_interfaces, msg, CocoaVIMU)() {
  return get_message_type_support_handle<cocoav_interfaces::msg::CocoaVIMU>();
}
