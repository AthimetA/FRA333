...
static const _CocoaIMU_type_support_symbol_names_t _CocoaIMU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoav_interfaces, msg, CocoaIMU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoav_interfaces, msg, CocoaIMU)),
  }
};
...
{
  return &::cocoav_interfaces::msg::rosidl_typesupport_cpp::CocoaIMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cocoav_interfaces, msg, CocoaIMU)() {
  return get_message_type_support_handle<cocoav_interfaces::msg::CocoaIMU>();
}
