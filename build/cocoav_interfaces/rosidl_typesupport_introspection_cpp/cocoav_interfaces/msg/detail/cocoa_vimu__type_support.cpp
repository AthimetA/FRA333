...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CocoaVIMU_message_member_array[3] = {
  {
    "time_ms",  // name
    ...
    offsetof(cocoav_interfaces::msg::CocoaVIMU, time_ms),  // bytes offset in struct
