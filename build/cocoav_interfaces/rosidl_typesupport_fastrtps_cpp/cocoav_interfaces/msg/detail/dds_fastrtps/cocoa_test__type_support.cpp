...
#include "cocoav_interfaces/msg/detail/cocoa_test__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cocoav_interfaces::msg::CocoaTest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cocoav_interfaces::msg::CocoaTest *>(
    untyped_ros_message);
...
{
  return &cocoav_interfaces::msg::typesupport_fastrtps_cpp::_CocoaTest__handle;
}
