...
static const _CocoaTestMonitor_type_support_symbol_names_t _CocoaTestMonitor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoax_interfaces, msg, CocoaTestMonitor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoax_interfaces, msg, CocoaTestMonitor)),
  }
};
...
{
  return &::cocoax_interfaces::msg::rosidl_typesupport_cpp::CocoaTestMonitor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cocoax_interfaces, msg, CocoaTestMonitor)() {
  return get_message_type_support_handle<cocoax_interfaces::msg::CocoaTestMonitor>();
}
