...
static const _CocoaTaskSpace_type_support_symbol_names_t _CocoaTaskSpace_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoax_interfaces, msg, CocoaTaskSpace)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoax_interfaces, msg, CocoaTaskSpace)),
  }
};
...
{
  return &::cocoax_interfaces::msg::rosidl_typesupport_cpp::CocoaTaskSpace_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cocoax_interfaces, msg, CocoaTaskSpace)() {
  return get_message_type_support_handle<cocoax_interfaces::msg::CocoaTaskSpace>();
}
