...
bool cocoax_interfaces__msg__cocoa_test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cocoax_interfaces.msg._cocoa_test.CocoaTest", full_classname_dest, 43) == 0);
  }
  cocoax_interfaces__msg__CocoaTest * ros_message = _ros_message;
  {  // check
...
PyObject * cocoax_interfaces__msg__cocoa_test__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cocoax_interfaces.msg._cocoa_test");
