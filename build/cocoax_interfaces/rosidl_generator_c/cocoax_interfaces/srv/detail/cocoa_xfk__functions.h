...
#ifndef COCOAX_INTERFACES__SRV__DETAIL__COCOA_XFK__FUNCTIONS_H_
#define COCOAX_INTERFACES__SRV__DETAIL__COCOA_XFK__FUNCTIONS_H_
...
/// Initialize srv/CocoaXFK message.
/**
...
/// Create srv/CocoaXFK message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoax_interfaces__srv__CocoaXFK_Request__init().
...
/// Destroy srv/CocoaXFK message.
/**
 * It calls
 * cocoax_interfaces__srv__CocoaXFK_Request__fini()
...
/// Check for srv/CocoaXFK message equality.
/**
...
/// Initialize array of srv/CocoaXFK messages.
/**
...
/// Finalize array of srv/CocoaXFK messages.
/**
 * It calls
 * cocoax_interfaces__srv__CocoaXFK_Request__fini()
...
/// Create array of srv/CocoaXFK messages.
/**
 * It allocates the memory for the array and calls
 * cocoax_interfaces__srv__CocoaXFK_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CocoaXFK messages.
/**
 * It calls
 * cocoax_interfaces__srv__CocoaXFK_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CocoaXFK message array equality.
/**
...
/// Copy an array of srv/CocoaXFK messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoax_interfaces__srv__CocoaXFK_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoax_interfaces
...
/**
 * It calls
 * cocoax_interfaces__srv__CocoaXFK_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoax_interfaces
...
/**
 * It allocates the memory for the array and calls
 * cocoax_interfaces__srv__CocoaXFK_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoax_interfaces
...
/**
 * It calls
 * cocoax_interfaces__srv__CocoaXFK_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COCOAX_INTERFACES__SRV__DETAIL__COCOA_XFK__FUNCTIONS_H_
