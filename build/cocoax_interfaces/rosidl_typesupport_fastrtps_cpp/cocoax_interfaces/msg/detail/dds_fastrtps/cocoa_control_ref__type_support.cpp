...
#include "cocoax_interfaces/msg/detail/cocoa_control_ref__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cocoax_interfaces
max_serialized_size_CocoaControlRef(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const cocoax_interfaces::msg::CocoaControlRef *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cocoax_interfaces::msg::CocoaControlRef *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CocoaControlRef__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cocoax_interfaces::msg::CocoaControlRef *>(
...
{
  return max_serialized_size_CocoaControlRef(full_bounded, 0);
}

static message_type_support_callbacks_t _CocoaControlRef__callbacks = {
...
static rosidl_message_type_support_t _CocoaControlRef__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CocoaControlRef__callbacks,
...
{
  return &cocoax_interfaces::msg::typesupport_fastrtps_cpp::_CocoaControlRef__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cocoax_interfaces, msg, CocoaControlRef)() {
  return &cocoax_interfaces::msg::typesupport_fastrtps_cpp::_CocoaControlRef__handle;
}
