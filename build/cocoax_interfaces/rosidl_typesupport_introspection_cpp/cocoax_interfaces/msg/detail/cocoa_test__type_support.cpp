...
{
  new (message_memory) cocoax_interfaces::msg::CocoaTest(_init);
}

void CocoaTest_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cocoax_interfaces::msg::CocoaTest *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CocoaTest_message_member_array[1] = {
  {
    ...
    offsetof(cocoax_interfaces::msg::CocoaTest, check),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CocoaTest_message_members = {
  ...
  1,  // number of fields
  sizeof(cocoax_interfaces::msg::CocoaTest),
...
{
  return &::cocoax_interfaces::msg::rosidl_typesupport_introspection_cpp::CocoaTest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoax_interfaces, msg, CocoaTest)() {
  return &::cocoax_interfaces::msg::rosidl_typesupport_introspection_cpp::CocoaTest_message_type_support_handle;
}
