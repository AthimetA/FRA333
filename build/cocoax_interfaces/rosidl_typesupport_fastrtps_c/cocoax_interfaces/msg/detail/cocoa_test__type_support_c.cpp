...
#include "cocoax_interfaces/msg/detail/cocoa_test__rosidl_typesupport_fastrtps_c.h"
...
using _CocoaTest__ros_msg_type = cocoax_interfaces__msg__CocoaTest;
...
size_t get_serialized_size_cocoax_interfaces__msg__CocoaTest(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CocoaTest__ros_msg_type * ros_message = static_cast<const _CocoaTest__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CocoaTest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cocoax_interfaces__msg__CocoaTest(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cocoax_interfaces
size_t max_serialized_size_cocoax_interfaces__msg__CocoaTest(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cocoax_interfaces__msg__CocoaTest(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cocoax_interfaces, msg, CocoaTest)() {
