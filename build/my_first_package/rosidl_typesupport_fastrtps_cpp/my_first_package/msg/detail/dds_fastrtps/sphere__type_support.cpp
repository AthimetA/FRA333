...
#include "my_first_package/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_first_package::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_first_package::msg::Sphere & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const my_first_package::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_first_package::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &my_first_package::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_first_package, msg, Sphere)() {
  return &my_first_package::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
