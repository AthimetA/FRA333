...
#include "my_first_package/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_first_package::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_first_package::msg::Num & ros_message)
{
  // Member: num1
  cdr >> ros_message.num1;
...
{
  auto typed_message =
    static_cast<const my_first_package::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_first_package::msg::Num *>(
    untyped_ros_message);
...
{
  return &my_first_package::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_first_package, msg, Num)() {
  return &my_first_package::msg::typesupport_fastrtps_cpp::_Num__handle;
}
