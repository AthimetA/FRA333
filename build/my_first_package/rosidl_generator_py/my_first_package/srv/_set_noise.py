...
class Metaclass_SetNoise(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_first_package.srv import _set_noise
...
class SetNoise(metaclass=Metaclass_SetNoise):
    from my_first_package.srv._set_noise import SetNoise_Request as Request
    from my_first_package.srv._set_noise import SetNoise_Response as Response
