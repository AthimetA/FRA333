...
class Metaclass_AddBook(type):
    """Metaclass of message 'AddBook'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_first_package.msg.AddBook')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__add_book
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__add_book
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__add_book
            cls._TYPE_SUPPORT = module.type_support_msg__msg__add_book
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__add_book
    ...
    def FEMALE(self):
        ...
        return Metaclass_AddBook.__constants['FEMALE']

    @property
    def MALE(self):
        """Message constant 'MALE'."""
        return Metaclass_AddBook.__constants['MALE']


class AddBook(metaclass=Metaclass_AddBook):
    """
    Message class 'AddBook'.
