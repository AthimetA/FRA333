...
#include "my_first_package/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
using _Num__ros_msg_type = my_first_package__msg__Num;
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_first_package__msg__Num(
...
{
  return max_serialized_size_my_first_package__msg__Num(
    full_bounded, 0);
}
