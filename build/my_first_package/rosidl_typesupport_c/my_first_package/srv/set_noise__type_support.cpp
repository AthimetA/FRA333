...
static const _SetNoise_Request_type_support_symbol_names_t _SetNoise_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package, srv, SetNoise_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_first_package, srv, SetNoise_Request)() {
  return &::my_first_package::srv::rosidl_typesupport_c::SetNoise_Request_message_type_support_handle;
}
...
static const _SetNoise_Response_type_support_symbol_names_t _SetNoise_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package, srv, SetNoise_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_my_first_package
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_first_package, srv, SetNoise_Response)() {
  return &::my_first_package::srv::rosidl_typesupport_c::SetNoise_Response_message_type_support_handle;
}
...
static const _SetNoise_type_support_symbol_names_t _SetNoise_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package, srv, SetNoise)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_first_package, srv, SetNoise)() {
  return &::my_first_package::srv::rosidl_typesupport_c::SetNoise_service_type_support_handle;
}
