...
: ${AMENT_CURRENT_PREFIX:="/home/azthorax/fra333_ws/install/package_name"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/package_name/environment/pythonpath.sh"
