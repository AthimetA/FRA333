...
#ifndef COCOA_KINEMATICS_INTERFACES__SRV__DETAIL__ROBOT_FK__FUNCTIONS_H_
#define COCOA_KINEMATICS_INTERFACES__SRV__DETAIL__ROBOT_FK__FUNCTIONS_H_
...
/// Initialize srv/RobotFK message.
/**
...
/// Create srv/RobotFK message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Request__init().
...
/// Destroy srv/RobotFK message.
/**
 * It calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Request__fini()
...
/// Check for srv/RobotFK message equality.
/**
...
/// Initialize array of srv/RobotFK messages.
/**
...
/// Finalize array of srv/RobotFK messages.
/**
 * It calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Request__fini()
...
/// Create array of srv/RobotFK messages.
/**
 * It allocates the memory for the array and calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotFK messages.
/**
 * It calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RobotFK message array equality.
/**
...
/// Copy an array of srv/RobotFK messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoa_kinematics_interfaces
...
/**
 * It calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoa_kinematics_interfaces
...
/**
 * It allocates the memory for the array and calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cocoa_kinematics_interfaces
...
/**
 * It calls
 * cocoa_kinematics_interfaces__srv__RobotFK_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COCOA_KINEMATICS_INTERFACES__SRV__DETAIL__ROBOT_FK__FUNCTIONS_H_
