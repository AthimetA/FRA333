...
{
  new (message_memory) cocoa_kinematics_interfaces::srv::CocoaFK_Request(_init);
}

void CocoaFK_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cocoa_kinematics_interfaces::srv::CocoaFK_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CocoaFK_Request_message_member_array[1] = {
  {
    ...
    offsetof(cocoa_kinematics_interfaces::srv::CocoaFK_Request, jointstate),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CocoaFK_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(cocoa_kinematics_interfaces::srv::CocoaFK_Request),
...
{
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_introspection_cpp::CocoaFK_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoa_kinematics_interfaces, srv, CocoaFK_Request)() {
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_introspection_cpp::CocoaFK_Request_message_type_support_handle;
}
...
void CocoaFK_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cocoa_kinematics_interfaces::srv::CocoaFK_Response(_init);
}

void CocoaFK_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cocoa_kinematics_interfaces::srv::CocoaFK_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CocoaFK_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cocoa_kinematics_interfaces::srv::CocoaFK_Response, positionendeffector),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CocoaFK_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cocoa_kinematics_interfaces::srv::CocoaFK_Response),
...
{
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_introspection_cpp::CocoaFK_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoa_kinematics_interfaces, srv, CocoaFK_Response)() {
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_introspection_cpp::CocoaFK_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers CocoaFK_service_members = {
  ...
  // see get_service_type_support_handle<cocoa_kinematics_interfaces::srv::CocoaFK>()
...
get_service_type_support_handle<cocoa_kinematics_interfaces::srv::CocoaFK>()
{
  ...
  auto service_type_support =
    &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_introspection_cpp::CocoaFK_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cocoa_kinematics_interfaces, srv, CocoaFK)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cocoa_kinematics_interfaces::srv::CocoaFK>();
}
