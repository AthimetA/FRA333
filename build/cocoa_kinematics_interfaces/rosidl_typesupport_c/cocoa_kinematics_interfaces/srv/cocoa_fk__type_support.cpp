...
static const _CocoaFK_Request_type_support_symbol_names_t _CocoaFK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cocoa_kinematics_interfaces, srv, CocoaFK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cocoa_kinematics_interfaces, srv, CocoaFK_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cocoa_kinematics_interfaces, srv, CocoaFK_Request)() {
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_c::CocoaFK_Request_message_type_support_handle;
}
...
static const _CocoaFK_Response_type_support_symbol_names_t _CocoaFK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cocoa_kinematics_interfaces, srv, CocoaFK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cocoa_kinematics_interfaces, srv, CocoaFK_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_cocoa_kinematics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cocoa_kinematics_interfaces, srv, CocoaFK_Response)() {
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_c::CocoaFK_Response_message_type_support_handle;
}
...
static const _CocoaFK_type_support_symbol_names_t _CocoaFK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cocoa_kinematics_interfaces, srv, CocoaFK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cocoa_kinematics_interfaces, srv, CocoaFK)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cocoa_kinematics_interfaces, srv, CocoaFK)() {
  return &::cocoa_kinematics_interfaces::srv::rosidl_typesupport_c::CocoaFK_service_type_support_handle;
}
