...
bool cocoa_kinematics_interfaces__srv__cocoa_fk__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cocoa_kinematics_interfaces.srv._cocoa_fk.CocoaFK_Request", full_classname_dest, 57) == 0);
  }
  cocoa_kinematics_interfaces__srv__CocoaFK_Request * ros_message = _ros_message;
  {  // jointstate
...
PyObject * cocoa_kinematics_interfaces__srv__cocoa_fk__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cocoa_kinematics_interfaces.srv._cocoa_fk");
...
ROSIDL_GENERATOR_C_EXPORT
bool cocoa_kinematics_interfaces__srv__cocoa_fk__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cocoa_kinematics_interfaces.srv._cocoa_fk.CocoaFK_Response", full_classname_dest, 58) == 0);
  }
  cocoa_kinematics_interfaces__srv__CocoaFK_Response * ros_message = _ros_message;
  {  // positionendeffector
