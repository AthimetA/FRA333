...
#include <stddef.h>
#include "my_first_package/srv/detail/set_noise__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  my_first_package__srv__SetNoise_Request__init(message_memory);
}

void SetNoise_Request__rosidl_typesupport_introspection_c__SetNoise_Request_fini_function(void * message_memory)
{
  my_first_package__srv__SetNoise_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetNoise_Request__rosidl_typesupport_introspection_c__SetNoise_Request_message_member_array[2] = {
  {
    ...
    offsetof(my_first_package__srv__SetNoise_Request, mean),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_first_package__srv__SetNoise_Request, variance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetNoise_Request__rosidl_typesupport_introspection_c__SetNoise_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(my_first_package__srv__SetNoise_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  my_first_package__srv__SetNoise_Response__init(message_memory);
}

void SetNoise_Response__rosidl_typesupport_introspection_c__SetNoise_Response_fini_function(void * message_memory)
{
  my_first_package__srv__SetNoise_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetNoise_Response__rosidl_typesupport_introspection_c__SetNoise_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_first_package__srv__SetNoise_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetNoise_Response__rosidl_typesupport_introspection_c__SetNoise_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(my_first_package__srv__SetNoise_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_my_first_package
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_members = {
  "my_first_package__srv",  // service namespace
  "SetNoise",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_Request_message_type_support_handle,
  NULL  // response message
  // my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_Response_message_type_support_handle
};

static rosidl_service_type_support_t my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_type_support_handle = {
  0,
  &my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise)() {
  if (!my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_type_support_handle.typesupport_identifier) {
    my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package, srv, SetNoise_Response)()->data;
  }

  return &my_first_package__srv__detail__set_noise__rosidl_typesupport_introspection_c__SetNoise_service_type_support_handle;
}
