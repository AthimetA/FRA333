...
bool my_first_package__msg__add_book__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_first_package.msg._add_book.AddBook", full_classname_dest, 38) == 0);
  }
  my_first_package__msg__AddBook * ros_message = _ros_message;
  {  // first_name
...
{
  /* NOTE(esteve): Call constructor of AddBook */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_first_package.msg._add_book");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AddBook");
