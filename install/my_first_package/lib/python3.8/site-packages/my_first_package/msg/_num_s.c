...
bool my_first_package__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_first_package.msg._num.Num", full_classname_dest, 29) == 0);
  }
  my_first_package__msg__Num * ros_message = _ros_message;
  {  // num1
...
PyObject * my_first_package__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_first_package.msg._num");
